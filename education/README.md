...
things, including bugs we hit and fixed. When a later step changes something from
an earlier one, we explain the change *in the later step* rather than rewriting the
earlier note, so you can follow the whole journey.
...
| 3 | [03-news-sentiment.md](03-news-sentiment.md) | Real news sentiment + impact scoring with VADER (S7.2/S7.3), the internal API, and a Dockerfile fix |
| 4 | [04-glossary.md](04-glossary.md) | Dictionary of every term used in these notes |
